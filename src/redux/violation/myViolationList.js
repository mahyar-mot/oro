...
import { MY_VIOLATION_LIST } from "../../utils/constants";
...
export const getAllViolationsList = (nationNo,querys) => async dispatch => {
    dispatch(startLoading());
    try{
        await api
            .get(UrlQuery(MY_VIOLATION_LIST(nationNo), querys))
            .then( response => {
