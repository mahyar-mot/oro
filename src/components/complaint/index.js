...
function Index(props) {
    ...
    const [myOverseers] = useState({getOwnSupervisors: false})
    const [isModalVisible, setIsModalVisible] = useState(false);
    const [resetForm, setResetForm] = useState(false);
    const dispatch = useDispatch();
    const { listCount } = useSelector(state => state.complaint.userList);
    ...
    return (
        <div className="mb-5">
            ...
            <div className="d-none d-md-block py-1">
                <span className="square-indicator ">فیلتر اعتراضات</span>
