        ...
        <div className="content px-xl-5">
            ...
            >
                ...
                <Row>
                    ...
                    {/* <Col className="px-2" xs={24} sm={12} md={12} lg={8} xl={4}>
                        <Form.Item label="سرناظر" name="hasHeadSupervisor">
                            <Select
                                size="large"
                                showSearch
                            ...
                            >
                                ...
                                <Select.Option value={true}>دارای سرناظر</Select.Option>
                                <Select.Option value={false}>بدون سرناظر</Select.Option>
                            </Select>
                        </Form.Item>
                    </Col>
                    <Col className="px-2" xs={24} sm={12} md={12} lg={8} xl={4}>
                        <Form.Item label="ناظر" name="hasSupervisor">
                            <Select
                                size="large"
                                showSearch
                                dropdownClassName="text-right"
                            ...
                            >
                                <Select.Option value="">همه</Select.Option>
                                <Select.Option value={true}>دارای ناظر</Select.Option>
                                <Select.Option value={false}>بدون ناظر</Select.Option>
                            </Select>
                        </Form.Item>
                    </Col> */}
                </Row>
