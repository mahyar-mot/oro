...
function OverseersList(props) {

    const [params, serParams] = useState({})
    const [myOverseers, serMyOverseers] = useState({getOwnSupervisors: false})
    ...
    function onChange(checkedValues) {
        serParams({...params, getOwnSupervisors: checkedValues.target.checked})
    ...
    return (
        <div className="mb-5">
            ...
            <div className="d-none d-md-block py-1">
                <span className="square-indicator ">فیلتر ناظران</span>
