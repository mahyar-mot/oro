...
function Index(props) {
    ...
    const { listCount } = useSelector(state => state.reports.list);
    ...
    return (
        <div className="mb-5">
            ...
            {/*                type="primary">  ثبت شکایت جدید </Button>*/}
            {/*    </NavLinkRouter>*/}
            {/*</div>*/}
            <div className="d-none d-md-block py-1">
                <span className="square-indicator ">فیلتر گزارشات</span>
            ...
            <div className="py-1 mt-3">
                <div className="d-flex justify-content-between">
                    ...
                    گزارش تایید یا عدم تایید کاربران 
