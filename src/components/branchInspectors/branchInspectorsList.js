...
function BranchInspectorsList(props) {
    ...
    const { listCount } = useSelector(state => state.branchInspector.list);
        ...
        <div className="mb-5">
            <div className="d-flex flex-wrap align-items-center justify-content-between">
                ...
                <div>
                    {
                        roles.includes( "7.5" ) && (
                            <NavLinkRouter to="/branchinspectors/add">
                                <Button className="px-2 mb-3 mb-sm-0" size="large" style={{fontSize: ".9rem"}}
                                        type="primary">  <AddUserPic />  افزودن بازرس </Button>
                            </NavLinkRouter>
                        )
                    }
                </div>
...
export default BranchInspectorsList
