...
import { getOverseersMonitoringReportExport, getOverseersMonitoringReportPDFExport, cleanOverseersExport } from '../../../redux/monitoring/excelExports';
...
const ReportModal = (props) => {
    ...
    const {listCount} = useSelector(state => state.monitoring.overseerReport);
    ...
    const handleOk = () => {
        ...
        dispatch(getOverseersMonitoringReportExport(props.InitialCDC, {...props.params, pageSize:listCount, columns: values}))
    };

    const handleOkPDF = () => {
        // setIsModalVisible(false);
        let values = form.getFieldValue("overseerCols")
        dispatch(getOverseersMonitoringReportPDFExport(props.InitialCDC, {...props.params, pageSize:listCount, columns: values}))
    };
