...
function Index(props) {
    ...
    const {listMonitoring, listCount} = useSelector(state => state.monitoring.overseerReport);
    ...
    return (
        <div className="mb-5">
            ...
            <div className="d-none d-md-block py-1">
                <span className="square-indicator ">فیلتر  جدول مانیتورینگ بازرسان
                </span>
            ...
            <div className="py-1 mt-3">
               ...
               جدول مانیتورینگ بازرسان

                        {/* <span className="text-muted mr-2 font-size-sm"> تعداد رکوردها : {listCount || 0} </span> */}
                    </span>
