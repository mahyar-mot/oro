...
function ListFilters(props) {
    ...
    const {status, assignmentTitle,nazerType} = useSelector(state => state.basicInfo);
                ...
                <Row>
                    ...
                    <Col className="px-2" xs={24} sm={12} md={12} lg={8} xl={4}>
                        ...
                        >
                            <Select
                                ...
                                showSearch
                                dropdownClassName="text-right"
                                placeholder=" نوع ناظر را انتخاب کنید"
                                // onChange={ value => setStatusFilter(value) }
                            >
                                {
                                    nazerType.map((item, index) => (
                                        <Select.Option value={item.value} key={index}>{item.name}</Select.Option>
                                    ))
                                }
                            </Select>
                    ...
                    <Col className="px-2" xs={24} sm={12} md={12} lg={8} xl={4}>
                        <Form.Item label="کدملی" name="nationalNo">
                            <Input placeholder="جست‌جوی کدملی ..."/>
                        </Form.Item>
                    </Col>
                    <Col className="px-2" xs={24} sm={12} md={12} lg={8} xl={4}>
                        <Form.Item label="نام شعبه" name="nameShobe">
                            <Input placeholder="جست‌جوی نام شعبه ..."/>
                        </Form.Item>
                    </Col>
                </Row>
                <Row>
