...
function ListFilters(props) {
    ...
    const {status, assignmentTitle, roleDisplayNameType} = useSelector(state => state.basicInfo);
        ...
        <div className="content px-xl-5">
            ...
            >
                ...
                <Row>
                    ...
                    <Col className="px-2" xs={24} sm={12} md={12} lg={8} xl={4}>
                        <Form.Item label="شماره موبایل" name="mobileNo">
                            <Input/>
                        </Form.Item>
                    </Col>
                    <Col className="px-2" xs={24} sm={12} md={12} lg={8} xl={4}>
                    ...
                    <Col className="px-2" xs={24} sm={12} md={12} lg={8} xl={4}>
                        ...
                        >
                            ...
                            >
                                {
                                    roleDisplayNameType.map((item, index) => (
                                        <Select.Option value={item.value} key={index}>{item.name}</Select.Option>
                                    ))
                                }
                            </Select>
