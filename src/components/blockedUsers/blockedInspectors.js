...
import InspectorsListTable from './inspectorsTable';
...
function BlockedInspectorsList(props) {
    ...
    return (
        <div className="mb-5">
            <div className="d-flex flex-wrap align-items-center justify-content-between">
                <div>
                    <span className="square-indicator ">فیلتر بازرسان مسدودی</span>

                </div>
            </div>
            <div className="d-none d-md-block py-1">
                <ListFilters serParams={serParams} myOverseers={myOverseers} isInspector={true} setIsModalVisible={setIsModalVisible} resetForm={resetForm}/>
            </div>
            ...
            <div className="py-1 mt-3">
                <Tabs activeKey={activePane} onChange={callback} unmountInactiveTabs={true} >
                    ...
                    <TabPane tab="بازرسان" key="2" >
                        <InspectorsListTable params={params} />
                    </TabPane>
                </Tabs>
            </div>
...
export default BlockedInspectorsList
