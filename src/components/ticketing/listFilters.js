...
function ListFilters(props) {
    ...
    const {status, ticketStateType} = useSelector(state => state.basicInfo);
                    ...
                    <Col className="px-2" xs={24} sm={12} md={12} lg={8} xl={4}>
                        <Form.Item
                            ...
                            >
                                ...
                                >
                                    {
                                        ticketStateType.map((item, index) => (<Select.Option value={item.value} key={index}>{item.name}</Select.Option>
                                        ))
                                    }
                                </Select>
                        </Form.Item>
