...
function ListFilters(props) {
    ...
    const {fileStateType} = useSelector(state => state.basicInfo);
        ...
        <div className="content px-xl-5">
            ...
            >
                ...
                <Row>
                    ...
                    <Col className="px-2" xs={24} sm={12} md={12} lg={8} xl={4}>
                        <Form.Item label="جستجو" name="fileName">
                            <Input placeholder="جست‌جوی نام‌فایل "/>
                        </Form.Item>
                    </Col>
                </Row>
                <Row>
